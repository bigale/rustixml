 ...
 * @returns {ParseResult}
 */
export function parse_ixml(grammar, input) {
    ...
    const ret = wasm.parse_ixml(ptr0, len0, ptr1, len1);
 ...
 * @returns {string}
 */
export function parse_ixml_template(grammar, input) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(grammar, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ptr1 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.parse_ixml_template(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function load_example_template(example_name) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(example_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.load_example_template(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
const IxmlParserFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_ixmlparser_free(ptr >>> 0, 1));
/**
...
export class IxmlParser {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        IxmlParserFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_ixmlparser_free(ptr, 0);
    }
    /**
    ...
    constructor(grammar) {
        const ptr0 = passStringToWasm0(grammar, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.ixmlparser_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        IxmlParserFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    parse(input) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.ixmlparser_parse(this.__wbg_ptr, ptr0, len0);
        return ParseResult.__wrap(ret);
    }
    /**
     ...
     */
    rule_count() {
        const ret = wasm.ixmlparser_rule_count(this.__wbg_ptr);
        return ret >>> 0;
    }
}
if (Symbol.dispose) IxmlParser.prototype[Symbol.dispose] = IxmlParser.prototype.free;
...
export class ParseResult {
    ...
    get output() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.parseresult_output(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rustixml_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
